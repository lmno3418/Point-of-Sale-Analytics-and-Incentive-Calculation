...
file_location = "/Users/lmno3418/Documents/PROJECTS/sem2-project/sales_data_to_s3/"
...
csv_file_path = os.path.join(file_location, f"extra_sales_data_{input_date_str}.csv")
